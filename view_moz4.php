                ...
                <div class="row">
                    <div class="col-md-4 col-sm-8">
                        <div class="service_item">
                            ...
                            <h3>Pizza</h3>
                            <a class="read_mor_btn" href="view_moz4.php">Mozarella</a>
                            <a class="read_mor_btn" href="view_quick3.php">Quickmelt</a>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-8">
                        <div class="service_item">
                            ...
                            <h3>Meals</h3>
                            <a class="read_mor_btn" href="view_meal2.php">View</a>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-8">
                        <div class="service_item">
                            ...
                            <h3>Drinks</h3>
                            <a class="read_mor_btn" href="view_drinks2.php">View</a>
                        </div>
                    </div>
                </div>
            </div>
