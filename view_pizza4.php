<?php include('nav.php');?>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-8">
                        <div class="service_item">
                            ...
                            <h3>Pizza</h3>
                            <a class="read_mor_btn" href="view_pizza.php?branch=<?php echo $branch;?>">Mozarella</a>    
                             <a class="read_mor_btn" href="view_pizza3.php?branch=<?php echo $branch;?>">Quickmelt</a>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-8">
                        <div class="service_item">
        ...
        <section class="most_popular_item_area">
            <div class="container">
                ...
                <center> <img src="images/paks2.png" alt=""> </center>
