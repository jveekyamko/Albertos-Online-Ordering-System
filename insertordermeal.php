<?php
                                    ...
                                    include ('admin/dbconn.php');
                                        ...
                                        $qty = $_POST['qty'];
                                        $sql="SELECT * from prodet where prod_id='$prod_id' ";
                                        ...
                                        $result2=mysqli_query($conn,$query2);
                                          ...
                                          if($branch==1){
                                            echo "<script>alert('Successfully Added!'); window.location = 'ordermeal.php?branch=1';</script>";
                                        }else if($branch==2){
                                            echo "<script>alert('Successfully Added!'); window.location = 'ordermeal.php?branch=2';</script>";
                                        }else if($branch==3){
                                            echo "<script>alert('Successfully Added!'); window.location = 'ordermeal.php?branch=3';</script>";
                                        }
                                     }else{

                                         if($branch==1){
                                            echo "<script>alert('Not Available!'); window.location = 'ordermeal.php?branch=1';</script>";
                                        }else if($branch==2){
                                            echo "<script>alert('Not Available!'); window.location = 'ordermeal.php?branch=2';</script>";
                                        }else if($branch==3){
                                            echo "<script>alert('Not Available!'); window.location = 'ordermeal.php?branch=3';</script>";
                                        }
                                    }
                                    }
                                        ?>
