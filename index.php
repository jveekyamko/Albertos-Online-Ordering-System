<?php include('nav2.php');?>
                            ...
                            <div class="slider_text_box">
                               <div class="tp-caption bg_box" 
                                ...
                                <div class="tp-caption secand_text" 
                                    ...
                                    data-splitout="none" 
                                    data-responsive_offset="on" 
                                    data-elementdelay="0.05" >Alberto's Pizza
                                </div>
                                <div class="tp-caption third_text" 
                                    ...
                                    data-splitout="none" 
                                    data-responsive_offset="on" 
                                    data-elementdelay="0.05" >A Taste You'll Surely Miss...
                                </div>
                                <div class="tp-caption btn_text" 
                                    ...
                                    data-splitout="none" 
                                    data-responsive_offset="on" 
                                    data-elementdelay="0.05" ><a class="submit_btn_bg" href="view_pizza2.php">Look Menu</a>
                                </div>
                            </div>
                        </li>
                        <li data-slotamount="7" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="600" data-rotate="0" data-saveperformance="off">
                            <!-- MAIN IMAGE -->
                            <img src="images/pizzahead.png"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                            <!-- LAYERS -->
                            ...
                            <div class="slider_text_box text_box2">
                                ...
                                <div class="tp-caption btn_text" 
                                    ...
                                    data-splitout="none" 
                                    data-responsive_offset="on" 
                                    data-elementdelay="0.05" ><a class="submit_btn_bg" href="#"></a>
                                </div>
                            </div>
                        </li>
                    </ul> 
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-8">
                        <div class="service_item">
                            ...
                            <h3>Pizzas</h3>
                            <a class="read_mor_btn" href="view_pizza.php">Read More</a>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-8">
                        <div class="service_item">
                            ...
                            <h3>Meals</h3>
                            <a class="read_mor_btn" href="view_meal.php">Read More</a>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-8">
                        <div class="service_item">
                            ...
                            <h3>Desserts</h3>
                            <a class="read_mor_btn" href="view_dessert.php">Read More</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="most_popular_item_area">
            <div class="container">
                ...
                <div>
               <center> <img src="images/ge.png"> </center>
                </div>
                        ...
                        <div class="recent_blog_item">
                            ...
                            <div class="recent_blog_text">
                                <div class="recent_blog_text_inner">
                                    ...
                                    <a href="http://www.everythingcebu.com/food-and-dining/cebu-loves-alberto%E2%80%99s-pizza/"><h5>By Everything Cebu</h5></a>
                                    <p>For delicious yet affordable pizzas in Cebu, it’s got to be Alberto’s Pizza!</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="recent_blog_item">
                            ...
                            <div class="recent_blog_text">
                                <div class="recent_blog_text_inner">
                                    <h6><a href="#">Reviews</a></h6>
                                    <a href="https://cebufinest.com/albertos-pizza-at-its-fresh-from-the-oven-best-pizza-straight-to-your-home/--""><h5>By Cebu Finest</h5></a>
                                    <p>Alberto’s Pizza at its fresh-from-the-oven best pizza straight to your home.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="recent_blog_item">
                            ...
                            <div class="recent_blog_text">
                                <div class="recent_blog_text_inner">
                                    <h6><a href="#">Reviews</a></h6>
                                    <a href="https://www.tripadvisor.com.ph/ShowUserReviews-g298460-d1229999-r89709186-Alberto_s_Pizza-Cebu_City_Cebu_Island_Visayas.html"><h5>By tripadvisor Philippines</h5></a>
                                    <p>This pizza will take you to the next level. There is nothing special 
                                    on it but the taste is loved by most cebuanos</p>
                                </div>
                            </div>
                        </div>
                    </div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | <i class="fa fa-heart-o" aria-hidden="true"></i> by JV.KATELYN.KIM.SHIELA :)
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                    ...
                    <div class="pull-right">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li><a href="view_pizza2.php">Menu</a></li>
                            <li><a href="menu-grid.php">Products</a></li>
