<?php include('nav.php');?>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-8">
                        <div class="service_item">
                            ...
                            <h3>Pizza</h3>
                            <a class="read_mor_btn" href="view_pizzamoz1.php?branch=<?php echo $branch;?>">Mozarella</a>    
                             <a class="read_mor_btn" href="view_pizzaquick1.php?branch=<?php echo $branch;?>">Quickmelt</a>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-8">
                        <div class="service_item">
                            <img src="images/meal.png" width="100px" height="100px" alt="">
                            <h3>Meals</h3>
                            <a class="read_mor_btn" href="view_meal.php?branch=<?php echo $branch;?>">View</a>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-8">
                        <div class="service_item">
                            ...
                            <h3>Drinks</h3>
                            <a class="read_mor_btn" href="view_drinks.php?branch=<?php echo $branch;?>">View</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="most_popular_item_area">
            <div class="container">
                ...
                <center> <img src="images/PIZZAB.jpg" alt="" height="800" width="1000"> </center>
                        ...
                        <div class="recent_blog_item">
                            ...
                            <div class="recent_blog_text">
                                <div class="recent_blog_text_inner">
                                    ...
                                    <p>
-
ALBERTOS-PIZZA-BOWLING-SET-588485
February 12, 2018
MORE than 10 teams will battle for supremacy in the Alberto’s Pizza 10th Anniversary
 Bowling Invitation Tournament, which kicks off on 
Feb. 16 at the SM City Cebu Bowling Center.</p>
